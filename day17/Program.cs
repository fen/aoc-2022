if (args is not [var file] || !File.Exists(file)) {
    Console.WriteLine("day17 <input>");
    return;
}

Console.WriteLine("Solve One: {0}", new Puzzle17(file).SolvePart1());
Console.WriteLine("Solve Two: {0}", new Puzzle17(file).SolvePart2());

public class Puzzle17 {
    private List<RockRow> rocks = new();

    public Puzzle17(string file)
    {
